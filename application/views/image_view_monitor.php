            ...
            <div class="container">
              <div class="row">
                ...
                <!-- check whether there are images or not -->
                  <?php if (count($image_monitor)): ?>
                  <div class="card" style="margin-bottom: 100px;">
                    <div class="card-body">
                      <br><br>
                      <a href="<?php echo base_url();?>equipos/monitores" class="btn btn-primary btn-flat"><span class="fas fa-arrow-left"></span>Volver</a>
                    <br><br>
                        <table class="table table-bordered table-striped">
                          ...
                          <!-- start of foreach loop to display images -->
                            <?php foreach($image_monitor as $row):?>
                            <tr>
                              <!-- <td><?php echo $row->image_id_monitor ?></td> -->
                              <td><?php echo $row->image_name_monitor ?></td>
                              <td><?php echo $row->image_category_monitor ?></td>
                              <td><img class="thumbnail" style="height: 100px; width: 100px;" src="<?php echo base_url() ?>assets/images/monitores/<?php echo $row->image_monitor ?>"></td>
                            </tr>
                            <?php endforeach; ?> 
                          <!-- end of foreach loop  -->
                        </tbody>  
