<section class="content-header">
    <h1>
        Puntos de Acceso <small> Listado</small>
    </h1>
                            ...
                            <tbody>
                                <?php foreach ($routers as $router): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $router->codigo?></td>
                                        <td><?php echo $router->fabricante?></td>
                                        <td><?php echo $router->modelo?></td>
                                        <td><?php echo $router->descripcion?></td>
                                        <td><?php echo $router->ultimo_mante?></td>
                                        <td><?php echo $router->nombres?></td>
                                        <td><?php echo $router->estado == 0 ?"Inactivo":"Activo";?></td>
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-flat btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $router->id;?>" title="Ver">
                                                    <span class="fa fa-eye"></span>
                                                </button>
                                                <a href="<?php echo base_url();?>equipos/routers/edit/<?php echo $router->id?>" class="btn btn-warning btn-flat" title="Editar"><span class="fa fa-pencil"></span></a>
                                                <?php if ($this->session->userdata("rol") == 1):  ?>
                                                    <a href="<?php echo base_url();?>equipos/routers/delete/<?php echo $router->id?>" class="btn btn-danger btn-flat btn-delete" title="Eliminar">
                                                    <span class="fa fa-times"></span>
                                                </a>
                                                <?php endif ?>
                                                
                                                <button type="button" class="btn btn-info btn-flat btn-mante" data-toggle="modal" data-target="#modal-mantenimiento" title="Mantenimientos" value="<?php echo $router->id?>">
      ...
      <div class="modal-body">
        ...
        <div class="tab-content">
            ...
            <div id="agregar" class="tab-pane fade">
                ...
                <form action="<?php echo base_url();?>equipos/routers/addmantenimiento" method="POST">
