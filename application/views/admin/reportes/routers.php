<section class="content-header">
    <h1>
        Reportes <small> Puntos de Acceso</small>
    </h1>
...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <a href="<?php echo base_url();?>reportes/routers" class="btn btn-danger btn-flat">Reestablecer</a>
                        </div>
                    </div>
                </div>
                <hr>
                            ...
                            <tbody>
                                <?php foreach ($routers as $router): ?>
                                    <tr>
                                        ...
                                        <?php $fecha = new DateTime($router->fecregistro); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <form action="<?php echo base_url();?>reportes/routers/exportar" method="POST">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Información del Punto de Acceso</h4>
      </div>
